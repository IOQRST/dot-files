  ...
  (setq-default
   ...
   '(
     ...
     (javascript :variables
                 ...
                 javascript-eslint 'eslint-rc
                 javascript-fmt-on-save t
                 javascript-fmt-tool 'prettier
                 javascript-import-tool 'import-js)
     (typescript :variables
                 typescript-backend 'lsp
                 typescript-linter 'eslint-rc
     ...
     toml
     (python :variable
             python-backend 'python-pyright
             python-lsp-server 'lsp-pyright
             python-test-runner 'python-pytest
             python-formatter 'ruff-format
             python-format-on-save t
             python-sort-imports 'python-isort
     ...
     (lua :variables
          ...
          lsp-clients-lua-language-server-bin "C:/Tools/Lua/luals/bin/lua-language-server.exe"
          lsp-clients-lua-language-server-main-location "C:/Tools/Lua/luals/bin/main.lua"
          lsp-clients-luarocks-bin-dir 'luarocks)
     (zig :variables
          zig-backend 'lsp)
     (go :variables
         go-backend 'lsp
         go-use-golangci-lint t
         gofmt-commant "goimports"
         go-tab-width 4
         go-format-before-save t)
     (dart :variable
           lsp-enable-on-type-formatting t
           lsp-dart-sdk-dir "C:\Tools\Flutter\bin")
     (sql :variables
          sql-backend 'lsp
     ...
     nginx
     (docker :variables
             docker-dockerfile-backend 'lsp-docker)
     )
   ...
   dotspacemacs-additional-packages '(zeno-theme ruff-format lsp-pyright python-isort python-pytest luarocks all-the-icons lsp-docker eslint-rc flymake-jshint standard-dirs import-js)
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-jump-helm-line ace-link aggressive-indent all-the-icons ansible
                          ...
                          company-ansible company-terraform company-web
                          cython-mode define-word devdocs diminish
                          dired-quick-sort disable-mouse docker dockerfile-mode
                          dotenv-mode drag-stuff dumb-jump eat edit-indirect
                          elisp-def elisp-demos elisp-slime-nav emmet-mode emr
                          esh-help eshell-prompt-extras eshell-vterm eshell-z
                          ...
                          flyspell-correct-helm gh-md gnuplot golden-ratio
                          google-translate helm-ag helm-c-yasnippet helm-comint
                          helm-company helm-css-scss helm-descbinds helm-lsp
                          ...
                          kivy-mode link-hint live-py-mode livid-mode lorem-ipsum
                          lsp-origami lsp-treemacs lsp-ui macrostep markdown-toc
                          multi-line multi-term multi-vterm mwim nameless
                          ...
                          overseer paradox password-generator pcre2el pet
                          pip-requirements pipenv pippel poetry pony-mode popwin
                          prettier-js pug-mode py-isort pydoc pyenv-mode pylookup
                          pytest quickrun rainbow-delimiters rainbow-identifiers
                          rainbow-mode restart-emacs sass-mode scss-mode shell-pop
                          ...
                          symon system-packages tagedit term-cursor terminal-here
                          ...
                          volatile-highlights vterm vundo web-beautify web-mode
                          wgrep winum writeroom-mode ws-butler yaml-mode
                          yasnippet-snippets)))
  (custom-set-faces
